// https://pkg.go.dev/github.com/pion/stun#section-readme
// https://pkg.go.dev/github.com/pion/turn/v2#section-readme
// https://github.com/pion/turn/tree/v2.0.9/examples

// https://example.com/bigbluebutton/api/stuns?sessionToken=5kw9e5jdhle54nt7 with coockies
...
func main() {
	...
	ping := flag.Bool("ping", true, "Run ping test")
	flag.Parse()
